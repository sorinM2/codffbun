...
public class Singleton_AutoSubsystem extends SubsystemBase{
    ...
    private Singleton_AutoSubsystem(ServoEx wrist, ServoEx wristRev, ServoEx claw, ServoEx latch,
                                   SampleMecanumDrive drive, DcMotor armRev, Lift lift, ServoEx chestie)
    {
        m_wrist = wrist;
        m_wristRev = wristRev;
        m_claw = claw;
                                               ...
                                               SampleMecanumDrive drive, DcMotor armRev, Lift lift, ServoEx chestie)
    {
        ...
        synchronized (Singleton_AutoSubsystem.class)
        {
            ...
            instance = new Singleton_AutoSubsystem(wrist,  wristRev,  claw,  latch, drive,  armRev,  lift, chestie);
        }
        return instance;
    }
